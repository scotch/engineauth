...
% macro quicklinks(github_user, github_repo, twitter_username, project_name, project_url)
  ul.quick-links
    ...
    li.divider | &middot;
    li > iframe.github-btn src="http://markdotto.github.com/github-buttons/github-btn.html?user={{ github_user }}&repo={{ github_repo }}&type=watch&count=true" allowtransparency="true" frameborder="0" scrolling="0" width="110px" height="20px" |
    li > iframe.github-btn src="http://markdotto.github.com/github-buttons/github-btn.html?user={{ github_user }}&repo={{ github_repo }}&type=fork&count=true" allowtransparency="true" frameborder="0" scrolling="0" width="94px" height="20px" |
    li.divider | &middot;
